...
max_xy = max(x1,[],2);
min_xy = min(x1,[],2);
net1 = NN_training(input, target, hidden, lr, epochs, train_fun);
...
hidden = 4;
net2 = NN_training(input, target, hidden, lr, epochs, train_fun);
...
hidden = 15;
net3 = NN_training(input, target, hidden, lr, epochs, train_fun);
...
nodes2x1 =  sprintf('2  hidden Error train :  %0.2f%%', x1_target_error_2*100);
nodes2x2 =  sprintf('2  hidden Error test :  %0.2f%%', x2_target_error_2*100);
nodes4x1 =  sprintf('4  hidden Error train :  %0.2f%%', x1_target_error_4*100);
nodes4x2 =  sprintf('4  hidden Error test :  %0.2f%%', x2_target_error_4*100);
nodes15x1 = sprintf('15 hidden Error train :  %0.2f%%', x1_target_error_15*100);
nodes15x2 = sprintf('15 hidden Error test :  %0.2f%%', x2_target_error_15*100);
